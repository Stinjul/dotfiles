...
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 ' + xresources['*.color0'] + ', stop:1 ' + xresources['*.background'] + ')'
...
c.colors.completion.item.selected.bg = xresources['*.color9']

## Bottom border color of the selected completion item.
## Type: QssColor
# c.colors.completion.item.selected.border.bottom = '#bbbb00'
c.colors.completion.item.selected.border.bottom = xresources['*.color9']

## Top border color of the completion widget category headers.
## Type: QssColor
# c.colors.completion.item.selected.border.top = '#bbbb00'
c.colors.completion.item.selected.border.top = xresources['*.color9']
...
c.colors.hints.bg = '#EE' + xresources['*.background'][1:]
...
# QColor accepts #AARRGGBB
c.colors.keyhint.bg = '#CC' + xresources['*.background'][1:]
...
c.colors.messages.error.border = xresources['*.color11']
...
c.colors.messages.info.border = xresources['*.color11']
...
c.colors.prompts.border = '1px solder ' + xresources['*.color3']
...
c.colors.prompts.selected.bg = xresources['*.color11']
...
c.colors.statusbar.command.private.bg = xresources['*.color5']
...
#c.colors.tabs.selected.even.bg = xresources['*.color9']
...
c.colors.tabs.selected.even.fg = xresources['*.color9']

## Background color of selected odd tabs.
## Type: QtColor
# c.colors.tabs.selected.odd.bg = 'black'
#c.colors.tabs.selected.odd.bg = xresources['*.color9']
...
c.colors.tabs.selected.odd.fg = xresources['*.color9']
...
c.fonts.monospace = 'Iosevka, "Iosevka Term"'
...
c.hints.border = '1px solid ' + xresources['*.color3']
